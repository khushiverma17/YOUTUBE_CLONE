        ...
        <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
            ...
            <div className="nav">
                <div className="topofyouinnav sectionofnav">
                    <a  className={`side-link ${category===0?"active":""}`}  onClick={(e) => { e.preventDefault(); setCategory(0); }}>
                ...
                <div className="explore sectionofnav">
                    ...
                    <a href="" className={`side-link ${category===10?"active":""}`} onClick={(e) => { e.preventDefault(); setCategory(10); }}>
                        <i className="material-icons sidebaricons">music_note</i>
                        <span>Music</span>
                    </a>
                    <a href="" className={`side-link ${category===23?"active":""}`} onClick={(e) => { e.preventDefault(); setCategory(23); }}>
                        <i className="material-icons sidebaricons">theaters</i>
                        <span>Comedy</span>
                    </a>
                   
                    <a href="" className={`side-link ${category===20?"active":""}`} onClick={(e) => { e.preventDefault(); setCategory(20); }}>
                        <i className="material-icons sidebaricons">sports_esports</i>
                        <span>Gaming</span>
                    </a>
                    <a href="" className={`side-link ${category===25?"active":""}`} onClick={(e) => { e.preventDefault(); setCategory(25); }}>
                        <i className="material-icons sidebaricons">feed</i>
                        <span>News</span>
                    </a>
                    <a href="" className={`side-link ${category===17?"active":""}`} onClick={(e) => { e.preventDefault(); setCategory(17); }}>
                        <i className="material-icons sidebaricons">emoji_events</i>
                        <span>Sports</span>
                    </a>
                    <a href="" className={`side-link ${category===28?"active":""}`} onClick={(e) => { e.preventDefault(); setCategory(28); }}>
