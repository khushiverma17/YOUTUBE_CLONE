...
//                     <a href="" className={`side-link ${category===0?"active":""}`} toshowsidee onClick={()=>setCategory(0)}>
//                         <i className="material-icons sidebaricons">home</i>
//                         <span>Home</span>
//                     </a>
//                     <a href="" className={`side-link ${category===42?"active":""}`}  toshowsideeonClick={()=>setCategory(42)}>
...
//                     <a href="" className={`side-link ${category===0?"active":""}`}  onClick={()=>setCategory(0)}sidebar-no-icons><span>You</span>
//                         <i className="material-icons sidebar-no-icon">chevron_right</i>
//                     </a>
//                     <a href="" className={`side-link ${category===0?"active":""}`}  onClick={()=>setCategory(0)} toshowsidee>
...
// In React, "props" (short for properties) are a fundamental concept used for passing data from one component to another. Props are immutable and are passed from parent components down to their children. They allow you to customize and configure React components dynamically.
    const Sidebar = ({sidebar,category,setCategory}) => {
        ...
        <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
            ...
            <div className="nav">
                <div className="topofyouinnav sectionofnav">
                    <a className={`side-link ${category===0?"active":""}`}  onClick={() => { console.log("Clicked Home"); setCategory(0); }}>
                        <i className="material-icons sidebaricons">home</i>
                        <span>Home</span>
                    </a>
                    <a className={`side-link ${category===42?"active":""}`}   onClick={() => { console.log("Clicked Home"); setCategory(42); }}>
                        <i className="material-icons sidebaricons">slow_motion_video</i>
                        <span>Shorts</span>
                    </a>
                    <a href="" className={`side-link ${category===0?"active":""}`}  onClick={()=>setCategory(0)}>
